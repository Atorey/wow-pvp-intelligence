  ...
  if (gap.state === "insufficient") {
    return (
      <Card className="border-t-warning-border gap-4 border-t-2 p-5">
        ...
        {/*
         * También aquí va la fecha: las dos cifras con las que se explica la
         * ausencia —la población y la muestra— salen de una corrida como
         * cualquier otra, y §28 no distingue entre cifras que gustan y cifras
         * que no.
         */}
        <RunProvenance locale={locale} computedAt={gap.computedAt} />
      </Card>
    );
  }
